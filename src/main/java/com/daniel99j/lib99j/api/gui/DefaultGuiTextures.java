...
public class DefaultGuiTextures {
    ...
    public static final GuiElementBuilder SOLID_COLOUR = GuiUtils.blank().model(Identifier.fromNamespaceAndPath(Lib99j.MOD_ID, "/gui/solid_colour")).setItemName(Component.nullToEmpty("==NOT SET=="));
