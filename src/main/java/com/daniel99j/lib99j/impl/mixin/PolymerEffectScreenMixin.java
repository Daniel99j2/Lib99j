...
public abstract class PolymerEffectScreenMixin {
    ...
    private Component fixTranslationEdit(Component original) {
        if(original.getContents() instanceof TranslatableContents translatableContents && translatableContents.getKey().equals("effect.minecraft.unluck") && Lib99j.SUPPORTED_LANGUAGES.contains(this.player.clientInformation().language())) {
