...
public class FixedPolymerBlockItem extends PolymerBlockItem {
    public FixedPolymerBlockItem(Block block, net.minecraft.item.Item.Settings settings) {
        this(block, settings, ItemUtils.getBasicModelItem(), true);
    }

    public FixedPolymerBlockItem(Block block, net.minecraft.item.Item.Settings settings, Item polymerItem) {
        super(block, settings, polymerItem);
    }

    public FixedPolymerBlockItem(Block block, net.minecraft.item.Item.Settings settings, Item polymerItem, boolean useModel) {
